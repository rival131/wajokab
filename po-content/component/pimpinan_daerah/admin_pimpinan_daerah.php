	...
	*/
	public function datatable()
	{
		...
		$columns = array(
			...
			array('db' => 'quote', 'dt' => '4', 'field' => 'quote'),
			array('db' => 'seourl', 'dt' => '5', 'field' => 'seourl'),
					...
					<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="nama" class="form-control" id="nama" value="<?=(isset($_POST['nama']) ? $_POST['nama']: '');?>" placeholder="Judul pimpinan_daerah" />
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="instagram" class="form-control" id="instagram" value="<?=(isset($_POST['instagram']) ? $_POST['instagram'] : '');?>" placeholder="Instagram" />
								</div>
							</div>
							...
							<div class="row">
						<div class="col-md-6">
								<?=$this->pohtml->inputText(array('type' => 'text', 'label' => $GLOBALS['_']['pimpinan_daerah'], 'name' => 'foto', 'id' => 'foto', 'mandatory' => true, 'options' => 'required',), $inputgroup = true, $inputgroupopt = array('href' => '../'.DIR_INC.'/js/filemanager/dialog.php?type=1&field_id=picture', 'id' => 'browse-file', 'class' => 'btn-success', 'options' => '', 'title' => $GLOBALS['_']['action_7'].' '.$GLOBALS['_']['pimpinan_daerah']));?>
							</div>
						</div>
						</div>
					...
					<?=$this->pohtml->formStart(array('method' => 'post', 'action' => 'route.php?mod=pimpinan_daerah&act=edit', 'autocomplete' => 'off'));?>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="nama">Nama Lengkap</label>
									<input type="text" name="nama" class="form-control" id="nama" value="<?=(isset($_POST['nama']) ? $_POST['nama'] : $current_pimpinan_daerah['nama']);?>" placeholder="Judul pimpinan_daerah" />
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="instagram">Instagram</label>
									<input type="text" name="instagram" class="form-control" id="instagram" value="<?=(isset($_POST['instagram']) ? $_POST['instagram'] : $current_pimpinan_daerah['instagram']);?>" placeholder="Instagram" />
								</div>
							</div>
							...
							<div class="row">
						<div class="col-md-6">
								<?=$this->pohtml->inputText(array('type' => 'text', 'label' => $GLOBALS['_']['pimpinan_daerah'], 'name' => 'foto', 'id' => 'picture', 'mandatory' => true, 'options' => 'required',), $inputgroup = true, $inputgroupopt = array('href' => '../'.DIR_INC.'/js/filemanager/dialog.php?type=1&field_id=picture', 'id' => 'browse-file', 'class' => 'btn-success', 'options' => '', 'title' => $GLOBALS['_']['action_7'].' '.$GLOBALS['_']['pimpinan_daerah']));?>
							</div>
						</div>
						</div>
						<div class="row">
