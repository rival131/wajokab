				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="swiper-container top-navigation" data-show-items="3">
                        ...
                        <?php
							...
							$querys = $this->pocore()->call->podb->from('pendidikankatsekolah')->orderBy('idkategori DESC')->limit($offset.','.$limit)->fetchAll();
							$notab = $offset+1;
                        ...
                        <div class="swiper-slide">
								<div class="curriculum-event c-green"  >
											...
											<div class="curriculum-event-content">
												<div class="author-block inline-items">
													<div class="author-avatar">
														<img src="<?=$this->asset('/images/logo/logo-pendidikan.png')?>" alt="author">
													</div>
													<div class="author-info">
														<div class="author-prof">Pemerintah</div>
														<a href="<?=BASE_URL.'/pendidikandetailsekolah/'.$this->e($query['seourl']);?>" class="h6 author-name">Kabupaten Wajo</a>
													</div>
												</div>
											</div>
										...
										<div class="curriculum-event-content">
											<a href="<?=BASE_URL.'/pendidikandetailsekolah/'.$this->e($query['seourl']);?>" class="h5 title"><?=$query['namakategori'];?></a>
										</div>
									</div>
							</div>
                  <?php } ?>
