 ...
 <div class="main-content">
      ...
      <div class="container-fluid p-0">
        ...
        <div class="rev_slider_wrapper">
          <div class="rev_slider" data-version="5.0">
            <ul>
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="<?=$this->asset('/images/slider/wtp.jpg')?>"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="<?=$this->asset('/images/slider/wtp.jpg')?>"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0 text-uppercase"
                  ...
                  style="z-index: 6; white-space: nowrap;">OPINI <span class="text-theme-colored">WTP</span>
                </div>
                ...
                <div class="tp-caption BigBold-SubTitle tp-resizeme rs-parallaxlevel-0"
                  ...
                  data-basealign="slide" 
                  data-responsive_offset="on"
                  style="z-index: 7; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;"><span class="text-theme-colored">Dari BPK RI Tahun 2013, 2016, 2017.</span>
                </div>
        ...
        <div class="row col-md-offset-2">
          <div class="col-sm-4">
            <div class="icon-box iconbox-theme-colored bg-lighter">
              <a class="round" href="#">
                <img src="<?=$this->asset('/images/bupati1.png')?>" class="profilfoto">
              </a>
              <h5 class="icon-box-title">BUPATI</h5>
              <p class="text-gray">DRS. H. ANDI BURHANUDDIN UNRU, MM</p>
          ...
          <div class="col-sm-4">
            <div class="icon-box iconbox-theme-colored bg-lighter">
              <a class="round" href="#">
                <img src="<?=$this->asset('/images/wabup1.png')?>" class="profilfoto">
              </a>
              <h5 class="icon-box-title">WAKIL BUPATI</h5>
              <p class="text-gray">DRS. H. ANDI SYAHRIR KUBE DAUDA, SE, M.Si</p>
              <a class="btn btn-flat btn-dark btn-sm mt-15" href="#">Read more</a>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="icon-box iconbox-theme-colored bg-lighter inner">
              <a class="round" href="#">
                <img src="<?=$this->asset('/images/setda1.png')?>" class="profilfoto">
              </a>
              <h5 class="icon-box-title">SEKERTARIS DAERAH</h5>
              <p class="text-gray">DR. H. FIRDAUS PERKESI, M.Si</p>
              <a class="btn btn-flat btn-dark btn-sm mt-15" href="#">Read more</a>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-4 wow fadeInLeft animation-delay6">
            <h4 class="text-uppercase line-bottom mt-0">Pengumuman</h4>
            <div class="featured-project-carousel owl-nav-top">
			<?php
				$post_by_categorys = $this->post()->getPostByCategory('6', '5', 'DESC', WEB_LANG_ID);
				foreach($post_by_categorys as $list_post){
			?>
              <div class="item">
                <div class="causes bg-lighter box-hover-effect effect1 sm-maxwidth500 mb-sm-30">
                  <div class="thumb">
                    <img class="img-fullwidth" height="195px" alt="" src="<?=BASE_URL;?>/<?=DIR_CON;?>/thumbs/<?=$list_post['picture'];?>">
                  </div>
                  ...
                  <p class="mb-10 mt-5"><span class="text-uppercase text-theme-colored"><?=$list_post['title'];?></p>
                     <div class="donate-details">
                       <a class="btn btn-dark btn-theme-colored btn-flat btn-sm pull-left mt-10" href="<?=BASE_URL;?>/detailpost/<?=$list_post['seotitle'];?>">Lihat</a>
          ...
          <div class="col-sm-12 col-md-4 wow fadeInUp animation-delay6">
            <h4 class="text-uppercase line-bottom mt-0">GPR KOMINFO</h4>
          ...
          <div class="col-sm-12 col-md-4 wow fadeInRight animation-delay6">
            <h4 class="text-uppercase line-bottom mt-0">Agenda Kegiatan</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6 p-0 pl-15">
                    <div class="event-content">
                      <h5 class="media-heading text-uppercase"><a href="#"><?=$agenda['judul_agenda'];?></a></h5>
                      <ul>
                        <li><i class="fa fa-clock-o"></i> jam <?=$agenda['jam'];?>.</li>
                        <li> <i class="fa fa-map-marker"></i> <?=$agenda['lokasi'];?>.</li>
                        <li> <i class="fa fa-calendar"></i> <?=$this->pocore()->call->podatetime->tgl_indo($agenda['tanggal']);?>.</li>
                      </ul>                    
                    </div>                
                  </div>
	...
	<section>
      <div class="panel panel-default">
        <div class="panel-heading section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3 class="text-uppercase mt-0">BERITA</h3>
              <div class="title-icon">
                <img src="<?=$this->asset('/images/wajo50px.png')?>"></img>
              </div>
        ...
        <div class="row">
          <div class="panel-body">
			...
			<?php
					$post_by_categorys = $this->post()->getPostByCategory('8', '5', 'DESC', WEB_LANG_ID);
					foreach($post_by_categorys as $list_post){
				?>
              ...
              <div class="item">
                ...
                <article class="post clearfix maxwidth600 mb-sm-30 wow fadeInRight" data-wow-delay=".2s">
                  <div class="entry-header">
                    <div class="post-thumb thumb"> <img src="<?=BASE_URL;?>/<?=DIR_CON;?>/uploads/<?=$list_post['picture'];?>" alt="" class="img-responsive img-fullwidth"> </div>
                    <div class="entry-meta meta-absolute text-center pl-15 pr-15">
                    <div class="display-table">
                      <div class="display-table-cell">
                        <!--<ul>
                          <li><a class="text-white" href="#"><i class="fa fa-thumbs-o-up"></i>  <br> </a></li>
                          <li class="mt-20"><a class="text-white" href="#"><i class="fa fa-comments-o"></i>=$this->post()->getCountComment($list_post['id_post']);?><br> </a></li>
                        </ul>-->
                      </div>
                    </div>
                    </div>
                  ...
                  <div class="entry-content border-1px p-20">
                    <h5 class="entry-title mt-0 pt-0"><a href="<?=BASE_URL;?>/detailpost/<?=$list_post['seotitle'];?>"> <?=$list_post['title'];?></a></h5>
                    <p class="text-left mb-20 mt-15 font-13"><?=$this->pocore()->call->postring->cuthighlight('post', $list_post['content'], '100');?></p>
                    <a class="btn btn-flat btn-dark btn-theme-colored btn-sm pull-left" href="<?=BASE_URL;?>/detailpost/<?=$list_post['seotitle'];?>">Read more</a>
                    <ul class="list-inline entry-date pull-right font-12 mt-5">
                      <li><a class="text-theme-colored" href="#"> <?=$this->post()->getAuthorName($list_post['editor']);?> |</a></li>
                      <li><span class="text-theme-colored"><?=$this->pocore()->call->podatetime->tgl_indo($list_post['date']);?></span></li>
                    </ul>
   ...
   <div class="container">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3 class="text-uppercase mt-0">STATISTIK KABUPATEN WAJO</h3>
              <div class="title-icon">
                <img src="<?=$this->asset('/images/wajo50px.png')?>"></img>
              </div>
              <p>Sumber Data Statistik : Wajo Dalam Angka 2017</p>
            </div>
          </div>
        </div>
    ...
    <!--DATA 1 -->
      ...
      <div class="panel-heading section-title text-center">
        <div class="row">
        <div class="col-md-8 col-md-offset-2">
        <h5 class="text-uppercase mt-0">LUAS WILAYAH KECAMATAN</h5>
        </div>
        </div>
      </div>
      ...
      <div class="panel-heading section-title text-center">
        <div class="row">
        <div class="col-md-8 col-md-offset-2">
        <h5 class="text-uppercase mt-0">LUAS LAHAN PERTANIAN</h5>
        </div>
        </div>
      </div>
      <div style="width: 100%" class="text-center">
      <div class="panel-body">
        <canvas id="pertanian"></canvas>
      </div>
      </div>
      </div>
        </div>
      ...
      <div class="panel-heading section-title text-center">
        <div class="row">
        <div class="col-md-8 col-md-offset-2">
        <h5 class="text-uppercase mt-0">LUAS LAHAN SAWAH</h5>
        </div>
        </div>
      </div>
      <div style="width: 100%" class="text-center">
      <div class="panel-body">
        <canvas id="persawahan"></canvas>
      </div>
      </div>
      </div>
        </div>
	...
	<section> 
	 <div class="container">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3 class="text-uppercase mt-0">MEDIA SOSIAL</h3>
              <div class="title-icon">
                <img src="<?=$this->asset('/images/wajo50px.png')?>"></img>
              </div>
              <p>Media Sosial Resmi Pemerintah Kabupaten Wajo</p>
            </div>
          </div>
        </div>
		...
		<!--DATA 1 -->
          <div class="col-sm-6 col-md-4 col-lg-4">
			...
			<div class="panel-heading section-title text-center">
				<div class="row">
				<div class="col-md-8 col-md-offset-2">
				<h5 class="text-uppercase mt-0">INSTAGRAM</h5>
				</div>
				</div>
			</div>
			<div class="row">
      ...
      <!-- END DATA 1 -->
          ...
          <div class="col-sm-6 col-md-4 col-lg-4">
			...
			<div class="panel-heading section-title text-center">
				<div class="row">
				<div class="col-md-8 col-md-offset-2">
				<h5 class="text-uppercase mt-0">FACEBOOK</h5>
				</div>
				</div>
			</div>
			<div class="row">
         ...
         <div class="col-sm-6 col-md-4 col-lg-4">
			...
			<div class="panel-heading section-title text-center">
				<div class="row">
				<div class="col-md-8 col-md-offset-2">
				<h5 class="text-uppercase mt-0">STREAMING</h5>
				</div>
				</div>
			</div>
			<div class="row">
	...
	<div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3 class="text-uppercase mt-0">WEBLINK SKPD</h3>
              <div class="title-icon">
                <img src="<?=$this->asset('/images/wajo50px.png')?>"></img>
              </div>
            </div>
		...
		<section>
          ...
          <div class="portfolio-filter font-alt align-center">
              ...
              <a href="#dinas" class="" data-filter=".dinas">Dinas</a>
              <a href="#badan" class="" data-filter=".badan">Badan</a>
              <a href="#kecamatan" class="" data-filter=".kecamatan">Kecamatan</a>
            </div>
            <!-- End Works Filter -->
	  ...
	  <!-- Portfolio Gallery Grid -->
            <div id="grid" class="gallery-isotope grid-5 gutter clearfix">
              ...
              <div class="gallery-item dinas">
                <div class="thumb">
                  <img class="img-fullwidth" src="<?=$this->asset('/images/skpd.jpg')?>" alt="project">
                  ...
                  <a class="hover-link" data-lightbox="image" href="<?=$this->asset('/images/skpd.jpg')?>">View more</a>
                </div>
              </div>
              <!-- Portfolio Item End -->
              
              <!-- Portfolio Item Start -->
             <div class="gallery-item badan">
                <div class="thumb">
                  <img class="img-fullwidth" src="<?=$this->asset('/images/skpd.jpg')?>" alt="project">
                  <div class="overlay-shade"></div>
                  <div class="icons-holder">
              ...
              <!-- Portfolio Item Start -->
              <div class="gallery-item kecamatan">
                <div class="thumb">
                  <img class="img-fullwidth" src="<?=$this->asset('/images/skpd.jpg')?>" alt="project">
                  <div class="overlay-shade"></div>
                  <div class="icons-holder">
    ...
    <section class="divider bg-lighter">
      <div class="container-fluid">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3 class="text-uppercase mt-0">APLIKASI DAERAH</h3>
              <div class="title-icon">
                <img src="<?=$this->asset('/images/wajo50px.png')?>"></img>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
             <div class="owl-carousel-5col">
				  <div class="item"><img src="<?=$this->asset('/images/app/bos.png')?>" alt=""></div>
				  <div class="item"><img src="<?=$this->asset('/images/app/raskin.png')?>" alt=""></div>
				  <div class="item"><img src="<?=$this->asset('/images/app/lkj.png')?>" alt=""></div>
				  <div class="item"><img src="<?=$this->asset('/images/app/lpse.png')?>" alt=""></div>
				  <div class="item"><img src="<?=$this->asset('/images/app/tpad.png')?>" alt=""></div>
				  <div class="item"><img src="<?=$this->asset('/images/app/ppid.png')?>" alt=""></div>
				  <div class="item"><img src="<?=$this->asset('/images/app/perizinan.png')?>" alt=""></div>
				  <div class="item"><img src="<?=$this->asset('/images/app/jdih.png')?>" alt=""></div>
				</div>
            </div>
          </div>
        </div>
